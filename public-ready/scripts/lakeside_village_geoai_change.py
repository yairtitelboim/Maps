#!/usr/bin/env python3
"""
Generate Lakeside Village (Lake Whitney) land-use change GeoJSON layers.

This mirrors the Whitney DFW7 exporter but uses a circular buffer centred on
Lakeside Village to capture change patterns along the northern shore.

Outputs:
  public/data/lakeside_village/lakeside_village_circle_<year1>_<year2>.geojson
  public/data/lakeside_village/lakeside_village_circle_<year1>_<year2>_stats.json
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Lakeside Village change exporter")
    parser.add_argument(
        "--output-dir",
        default=os.path.join("public", "data", "lakeside_village"),
