#!/usr/bin/env python3
"""
Generate Sentinel-2 change GeoJSON layers for the Shearon Harris Nuclear Power Plant AOI (North Carolina).

Outputs:
  public/data/harris_nc/harris_nc_<year1>_<year2>.geojson
  public/data/harris_nc/harris_nc_<year1>_<year2>_stats.json
"""
...
SITE_ID = "harris_nc"
SITE_NAME = "Shearon Harris Nuclear Power Plant"
# New Hill, NC (lng, lat)
SITE_CENTER = (-78.9531, 35.6506)
# 3x larger radius than other NC sites (e.g., 15 km)
SITE_RADIUS_METERS = 15000
...
VECTOR_SCALE = 60
STATS_SCALE = 60
# Larger AOI requires a higher cap to avoid partial exports
FEATURE_LIMIT = 15000
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Harris NC change exporter")
    parser.add_argument(
        "--output-dir",
